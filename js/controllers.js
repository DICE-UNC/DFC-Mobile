angular.module('app.controllers', [])
 ...
 //*   CONTROLLER    *
 //=================== 
.controller('homeCtrl', ['$scope', '$log', '$http', 'globals', '$state', 'Upload', 'profileService', function($scope, $log, $http, $globals, $state, Upload, profileService) {
    ...
    $scope.currentCollection = function(){
    	if($scope.collectionListingDropdown.collectionAndDataObjectListingEntries[0].description == "Starred from Cloud Browser"){
    		...
    		document.getElementById("searchTerm").style.width = "70%";
